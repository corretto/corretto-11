...
The following issues are addressed in 11.0.32.12.1:
...
| Fix macos info.plist version string metadata (#79) | macOS | Adds openjdk patch version string when it is non-zero | [PR-79](https://github.com/corretto/corretto-25/pull/79) |
...
The following issues are addressed in 11.0.31.11.1:

| Issue Name            | Platform | Description                                    | Link                                                                            |
|-----------------------|----------|------------------------------------------------|---------------------------------------------------------------------------------|
| Import jdk-11.0.31+11 | All      | Update Corretto baseline to OpenJDK 11.0.31+11 | [jdk-11.0.31+11](https://github.com/openjdk/jdk11u/releases/tag/jdk-11.0.31+11) |

The following CVEs are addressed in 11.0.31.11.1:
...
The following issues are addressed in 11.0.29.7.1:

| Issue Name | Platform | Description | Link |
|------------|----------|-------------|------|
| Import jdk-11.0.29+7 | All | Update Corretto baseline to OpenJDK 11.0.29+7 | [jdk-11.0.29+7](https://github.com/openjdk/jdk11u/releases/tag/jdk-11.0.29+7) |
...
| Bundling async profiler | Alpine, MacOS, RPM-based Linux, Debian-based Linux  | Binaries for the [async-profiler](https://github.com/async-profiler/async-profiler) are included in official builds for supported platforms | [#398](https://github.com/corretto/corretto-11/pull/398) |


The following CVEs are addressed in 11.0.29.7.1:
...
The following issues are addressed in 11.0.28.6.1:

| Issue Name | Platform | Description | Link |
|------------|----------|-------------|------|
| Import jdk-11.0.28+6 | All | Update Corretto baseline to OpenJDK 11.0.28+6 | [jdk-11.0.28+6](https://github.com/openjdk/jdk11u/releases/tag/jdk-11.0.28+6) |
 | JDK-8318696 | Linux | Do not use LFS64 symbols on Linux | [PR-390](https://github.com/corretto/corretto-11/pull/390) |


The following CVEs are addressed in 11.0.28.6.1:
...
The following issues are addressed in 11.0.26.4.1:

| Issue Name                                 | Platform | Description                                                          | Link                                                                          |
|--------------------------------------------|----------|----------------------------------------------------------------------|-------------------------------------------------------------------------------|
| Import jdk-11.0.26+4   | All      | Update Corretto baseline to OpenJDK 11.0.26+4                        | [jdk-11.0.26+4](https://github.com/openjdk/jdk11u/releases/tag/jdk-11.0.26+4) |
| JDK-8339637            | All      | Update timezone data to 2024b.  | [JDK-8339637](https://bugs.openjdk.org/browse/JDK-8339637) |
| JDK-8339803            | All      | TZDB spec allows not only month/weekday names, but the keywords themselves can be case-insensitive and unambiguous abbreviations. | [JDK-8339803](https://bugs.openjdk.org/browse/JDK-8339803) |
| JDK-8339644            | All      | Improved parsing of Day/Month in tzdata rules.  | [JDK-8339644](https://bugs.openjdk.org/browse/JDK-8339644) |
| JDK-8341059            | All      | Change Entrust TLS distrust date to November 12, 2024  | [JDK-8341059](https://bugs.openjdk.org/browse/JDK-8341059) |
| JDK-8341057            | All      | Add 2 SSL.com TLS roots.  | [JDK-8341057](https://bugs.openjdk.org/browse/JDK-8341057) |
...
The following CVEs are addressed in 11.0.26.4.1:
...
| Issue Name                                 | Platform | Description                                                          | Link                                                                          |
|--------------------------------------------|----------|----------------------------------------------------------------------|-------------------------------------------------------------------------------|
| Import jdk-11.0.24+8                       | All      | Update Corretto baseline to OpenJDK 11.0.24+8                        | [jdk-11.0.24+8](https://github.com/openjdk/jdk11u/releases/tag/jdk-11.0.24+8) |
| Re-enable DTLS1.0                          | All      | Re-enable DTLS to not change default TLS                             | [corretto-11/pull/366](https://github.com/corretto/corretto-11/pull/366)      |
